...
:: Generate comprehensive live documentation for all reports in ActiveReports/
...
:: Run documentation generator on ActiveReports directory
python "%~dp0Scripts\generate_live_docs.py" "%~dp0ActiveReports"
