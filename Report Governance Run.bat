...
echo.
echo  This tool will scan the 'ActiveReports' directory for
...
:: Scan the 'ActiveReports' directory specifically
python "%~dp0Validators\check_governance.py" "%~dp0ActiveReports"
